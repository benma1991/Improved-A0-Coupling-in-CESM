module cam_cpl_indices
  ...
  !-----------added by Ma-------------------------------------------
  integer :: index_a2x_Sa_ud           ! bottom atm level zon wind
  integer :: index_a2x_Sa_vd           ! bottom atm level mer wind
  integer :: index_a2x_Sa_du_ptend     ! bottom atm level zon wind
  integer :: index_a2x_Sa_dv_ptend     ! bottom atm level mer wind
  !-----------------------------------------------------------------
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    !----------------added by Ma------------------------------------
    index_a2x_Sa_ud         = mct_avect_indexra(a2x,'Sa_ud')
    index_a2x_Sa_vd         = mct_avect_indexra(a2x,'Sa_vd')
    index_a2x_Sa_du_ptend   = mct_avect_indexra(a2x,'Sa_du_ptend')
    index_a2x_Sa_dv_ptend   = mct_avect_indexra(a2x,'Sa_dv_ptend')
    !---------------------------------------------------------------
